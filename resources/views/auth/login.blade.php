            ...
            <form method="POST" action="/login">
                ...
                <div class="space-y-4">
                    ...
                    <div class="input-icon">
                        ...
                        <input id="email" type="email" name="email" class="w-full px-4 py-2 border rounded-lg focus:ring-blue-500 focus:border-blue-500 montserrat-regular" placeholder="Username" required />
                    </div>
