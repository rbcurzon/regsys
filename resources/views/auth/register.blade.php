                            ...
                            <div class="grid grid-cols-6 gap-4">
                                <x-form-field class="col-span-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
                                    <x-form-select id="year_level"
                                                   ...
                                                   required
                                    >
{{--                                        <option value="{{ old('year_level') }}"></option>--}}
                                        <option style="display: none" value="-1">Year level</option>
                                        @foreach($year_levels as $year_level)
                                            <option value="{{ $year_level }}" @selected(old('year_level') == $year_level)>
                                                {{ $year_level }}
                                            </option>
                                        @endforeach
                                    </x-form-select>
                                    ...
                                    >
                                        ...
                                        @foreach($courses as $course)
                                            <option value="{{ $course->course_id }}" @selected(old('course_id'))>{{ $course->course_name }}</option>
                                        @endforeach
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-6 gap-4">
                                ...
                                <x-form-field class="col-span-6 flex-col">
                                    <div x-data="{ showPassword: false }" class="relative">
...
{{--                                        <x-error field="password" class="text-white"></x-error>--}}
{{--                                        <x-form-error name="password"></x-form-error>--}}
                                    </div>
                                </x-form-field>
                            </div>
