...
@section('content')
    <div class="flex items-center justify-center mt-10 sm:mt-20 px-4 sm:px-0">
        <x-layout-main class=" w-full max-w-lg">
            ...
            <div class="bg-blue-900 text-white p-4 rounded-t-lg flex flex-col sm:flex-row items-center sm:justify-between">
                <!-- Left Logo -->
                <img src="https://github.com/Hanzcy/Pictures/raw/main/images/CCC%20LOGO.png" alt="CCC Logo" class="h-12 w-12 sm:h-16 sm:w-16 object-contain mb-2 sm:mb-0">
            ...
            <div class="bg-white shadow-lg rounded-b-lg p-4 sm:p-6 space-y-4">
                <div class="flex justify-center sm:justify-end">
                    <h2 class="text-indigo-900 text-base sm:text-lg font-bold">Transaction ID: {{ $transaction->id }}</h2>
                </div>
                ...
                <div class="text-center">
                    ...
                    <p class="text-xs sm:text-sm text-gray-600 mt-1">Available from 8:00 AM to 5:00 PM, Monday to Friday</p>
                </div>
