    ...
    <x-layout-main>
        ...
        @if($user->is_treasurer)
            ...
            <x-table>
                <x-slot:table_headers>
                    ...
                    <x-table-data>Credit</x-table-data>
                    <x-table-data>Debit</x-table-data>
                </x-slot:table_headers>
        ...
        @elseif($user->is_admin)
            ...
            <x-card-group>
                ...
                <x-card>
                    <x-slot:card_title>Received</x-slot:card_title>
                    0
                </x-card>
            </x-card-group>
            <x-table>
                <x-slot:table_headers>
                    ...
                    <x-table-header>user_id</x-table-header>
        ...
        @else
            ...
            <x-card-group>
                <x-card>
                    <x-slot:card_title>Request</x-slot>
                    {{ $pending_count }}
                </x-card>
                <x-card>
                    <x-slot:card_title>Status</x-slot>
                    0
                </x-card>
                <x-card>
                    <x-slot:card_title>Received</x-slot>
                    0
                </x-card>
            </x-card-group>
            <x-table>
                    ...
                    @foreach ($transactions as $transaction)
                        @can("edit-transaction", $transaction)
                            <tr class="hover:bg-blue-200">
                                <x-table-data>{{ $transaction->id }}</x-table-data>
                                <x-table-data>{{ $transaction->user_id }}</x-table-data>
                                <x-table-data>{{ $user->course->code }}</x-table-data>
